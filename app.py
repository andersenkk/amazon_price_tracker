...
from database import (
    init_database, get_all_products, add_product, 
        init_database, get_all_products, add_product, delete_product,
...
@app.route('/style.css')
def style_css():
    """Serve the dashboard stylesheet from the style folder."""
    return send_from_directory(os.path.join(app.root_path, 'style'), 'style.css')
